    ...
    <?php //if ($currentPage === 'organizations'): ?>
    <script src="<?php echo BASE_PATH; ?>/js/organization.js"></script>
    <?php //endif; ?>
    
    <?php //if ($currentPage === 'users'): ?>
    <script src="<?php echo BASE_PATH; ?>/js/user.js"></script>
    <?php // endif; ?>
    
    <?php //if ($currentPage === 'schedule'): ?>
    <script src="<?php echo BASE_PATH; ?>/js/schedule.js"></script>
    <?php //endif; ?>
