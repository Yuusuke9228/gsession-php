...
class OrganizationController {
    ...
    public function index() {
        ...
        require_once __DIR__ . '/../views/organization/index.php';
    ...
    public function create() {
        ...
        // ビューを読み込む
        require_once __DIR__ . '/../views/layouts/header.php';
        require_once __DIR__ . '/../views/organization/create.php';
        require_once __DIR__ . '/../views/layouts/footer.php';
    }
    ...
    public function edit($params) {
        ...
        $id = $params['id'] ?? null;
        if (!$id) {
            header('Location:' . BASE_PATH . '/organizations');
            exit;
        }
        ...
        // ビューを読み込む
        require_once __DIR__ . '/../views/layouts/header.php';
        require_once __DIR__ . '/../views/organization/edit.php';
        require_once __DIR__ . '/../views/layouts/footer.php';
    }
    ...
    public function view($params) {
        ...
        // ビューを読み込む
        require_once __DIR__ . '/../views/layouts/header.php';
        require_once __DIR__ . '/../views/organization/view.php';
        require_once __DIR__ . '/../views/layouts/footer.php';
    }
