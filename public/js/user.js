...
const User = {
    ...
    initUserTable: function() {
        this.dataTable = $('#users-table').DataTable({
                    ...
                    render: function(data, type, row) {
                        return `
                            <div class="btn-group" role="group">
                                <a href="/users/view/${row.id}" class="btn btn-sm btn-info">
                                    <i class="fas fa-eye"></i> 詳細
                                </a>
                                <a href="/users/edit/${row.id}" class="btn btn-sm btn-primary">
                                    <i class="fas fa-edit"></i> 編集
                                </a>
                                <button type="button" class="btn btn-sm btn-danger btn-delete" data-url="/api/users/${row.id}" data-confirm="ユーザー「${row.display_name}」を削除しますか？">
            ...
            order: [[2, 'asc']], // 表示名でソート
            language: {
                url: '/js/vendor/dataTables.japanese.json'
            }
        });
    },
                        ...
                        organizations.forEach(org => {
                            ...
                            html += `
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="/organizations/view/${org.id}">${org.name}</a>
                                        ${primaryBadge}
                                    </div>
                                </li>
                            `;
